  ...
  return (
    <section ref={ref} id="home" className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]">
      ...
      >
        ...
        <span className="font-bold">Hello, I'm Quoc Thai Phan.</span> I enjoy
      ...
      >
        ...
        <a
          ...
          href="/QuocThaiPhan_CV.pdf" download={true}>
        ...
        <a
          ...
          href="https://www.linkedin.com/in/quocthaiphan"
          target="_blank"
        >
          <BsLinkedin/>
        </a>
        <a
          ...
          href="https://github.com/pqthai96"
          target="_blank">
          <FaGithubSquare/>
        </a>
      </motion.div>
